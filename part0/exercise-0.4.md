...
sequenceDiagram
    ...
    Note right of browser: The user submits a new note: "This is a note!"

    browser->>server: POST https://studies.cs.helsinki.fi/exampleapp/new_note
    activate server
    server-->>browser: The server sends HTTP redirect to the browser to go to /notes page
    deactivate server
    ...
    activate server
    server-->>browser: The server sends back the JavaScript file stored as main.js
    deactivate server
